/**
* @name Assign All Badges
* @description Asign all badges that discord have to your profile. Code by @benedev
* @source https://github.com/invalidbene/AssignAllBadges
*/
